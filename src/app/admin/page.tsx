...
import { isCurator, type Contribution } from '@/types';
    ...
    return (
      <main style={{ padding: '120px 56px', maxWidth: 640, margin: '0 auto', textAlign: 'center' }}>
        ...
        <p style={{ color: p.inkSoft, marginTop: 20, fontSize: 15, lineHeight: 1.6 }}>
          Ton compte a le rôle <strong>{profile?.role ?? 'inconnu'}</strong>. Pour
          obtenir les droits de conservation, exécute dans le SQL Editor de Supabase :
        </p>
        <pre style={{
